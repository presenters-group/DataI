export const TEST_SVG_CHART = `<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
     width="1400" height="1000.0" viewBox="0 -1000.0 1400 1000.0">
<defs>
</defs>
<rect x="0" y="-1000.0" width="1400" height="1000.0" fill="#ffffff" />
<rect x="0" y="-1000.0" width="1400" height="1000.0" fill="#ffffff" />
...
<circle cx="350" cy="-507.55788553953687" r="5" fill="#DBD56E" stroke-width="0" stroke="black" id="0" />
<circle cx="500" cy="-556.4875491480996" r="5" fill="#DBD56E" stroke-width="0" stroke="black" id="1" />
<circle cx="650" cy="-577.4574049803407" r="5" fill="#DBD56E" stroke-width="0" stroke="black" id="2" />
<circle cx="800" cy="-423.6784622105723" r="5" fill="#DBD56E" stroke-width="0" stroke="black" id="3" />
<circle cx="950" cy="-885.0152905198776" r="5" fill="#DBD56E" stroke-width="0" stroke="black" id="4" />
<circle cx="1100" cy="-654.346876365225" r="5" fill="#DBD56E" stroke-width="0" stroke="black" id="5" />
<circle cx="1250" cy="-200.0" r="5" fill="#DBD56E" stroke-width="0" stroke="black" id="6" />
<circle cx="350" cy="-200" r="8" fill="black" stroke-width="0" stroke="black" />
<text x="344.0" y="-153.84615384615384" font-size="20.0" id="7">0</text>
<circle cx="500" cy="-200" r="8" fill="black" stroke-width="0" stroke="black" />
<text x="488.0" y="-153.84615384615384" font-size="20.0" id="8">15</text>
<circle cx="650" cy="-200" r="8" fill="black" stroke-width="0" stroke="black" />
<text x="644.0" y="-153.84615384615384" font-size="20.0" id="9">0</text>
<circle cx="800" cy="-200" r="8" fill="black" stroke-width="0" stroke="black" />
<text x="788.0" y="-153.84615384615384" font-size="20.0" id="10">33</text>
<circle cx="950" cy="-200" r="8" fill="black" stroke-width="0" stroke="black" />
<text x="944.0" y="-153.84615384615384" font-size="20.0" id="11">2</text>
<circle cx="1100" cy="-200" r="8" fill="black" stroke-width="0" stroke="black" />
<text x="1082.0" y="-153.84615384615384" font-size="20.0" id="12">111</text>
<circle cx="1250" cy="-200" r="8" fill="black" stroke-width="0" stroke="black" />
<text x="1238.0" y="-153.84615384615384" font-size="20.0" id="13">22</text>
<circle cx="30" cy="-58.0" r="12" fill="gray" stroke-width="5" stroke="black" />
<text x="55" y="-50.0" font-size="20.0" id="14">السعر</text>
<circle cx="180" cy="-58.0" r="15" fill="#DBD56E" stroke-width="0" stroke="black" />
<text x="205" y="-50.0" font-size="20.0" id="14">size</text>
<circle cx="200" cy="-200.0" r="10" fill="lightgray" stroke-width="5" stroke="gray" />
<text x="57.142857142857146" y="-200.0" font-size="20" id="14">0.0</text>
...
<path d="M350,-200.0 V-200.0" stroke-width="2" stroke="#26C485" fill="#26C485" fill-opacity="0.1" id="21" />
<path d="M350,-200.0 L350,-507.55788553953687 L500,-556.4875491480996 L650,-577.4574049803407 L800,-423.6784622105723 L950,-885.0152905198776 L1100,-654.346876365225 L1250,-200.0 V-200.0" stroke-width="2" stroke="#DBD56E" fill="#DBD56E" fill-opacity="0.1" id="22" />
</svg>`
